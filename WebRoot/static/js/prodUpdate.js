	...
	var htmls = "<div class='layout'>"+
			...
			"<div class='main'>"+
				...
				"<div class='freightTemplet_btns mt15'>"+
					"<input type='button' value='OK' onclick=\"javascript:self.location='product_list';\" class='btn btn-sm btn-sgGreen'>"+
				"</div>"+
			"</div>"+
		"</div>";
	$(".shade_layout").show();
...
function innerInit(){
	javascript:self.location='product_list';
}
/**
 * 修改Sku属性的枚举值
 */
...
{  
	...
	{  
		...
		skuHtml=skuHtml+"<td hidden><input type='text' class='text' maxlength='8' name='prop_originprice' size='10' maxlength='8' value='"+originprice_val+"'\" readonly></td><td><input name='prop_skuid' type='hidden' value='"+sku_val+"'><input name='skuProdId' type='hidden' value='"+skuProdId_val+"'><input name='prop_skuval' type='hidden' value=''><input type='text' class='text' maxlength='8' name='prop_price' size='10' value='"+price_val+"'\"></td><td><a href='javascript:void(0);' onclick='delPropCascade(this)'>Delete</a></td></tr>";
